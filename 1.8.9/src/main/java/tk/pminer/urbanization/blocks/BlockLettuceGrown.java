...
public class BlockLettuceGrown extends Block
{
	public BlockLettuceGrown(Material materialIn)
	{
		super(materialIn);
		setHardness(0.0F);
	...
	{
		return new ItemStack(Item.getItemFromBlock(UrbanizationBlocks.lettuce_1));
	}
	@Override
	public Item getItemDropped(IBlockState state, Random rand, int fortune) 
	{
		return UrbanizationItems.lettuce;
	}
}
